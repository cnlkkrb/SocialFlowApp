                  ...
                  <TouchableOpacity
                    ...
                    <TouchableOpacity
                      ...
                      <Box
                        ...
                        backgroundColor="lightGrey"
                      />
                      <Box mx='s' flexDirection='row' justifyContent='space-between' alignItems='center'>
                      <Text>Unapprove</Text>
                      <SmallCalendarIcon />
                      </Box>
                      <Box
                      ...
                      <Box
                        ...
                        backgroundColor="lightGrey"
                      />
                      <Box mb='xs' mx='s' flexDirection='row' justifyContent='space-between' alignItems='center'>
                      <Text>
                        option3
                      </Text>
