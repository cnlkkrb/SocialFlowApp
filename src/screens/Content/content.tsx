          ...
          }}>
            {
              isSelected ? (
                <Box flexDirection='row' justifyContent='space-between' mx='m' mt='m'>
                  <Text color='bg50' fontWeight='700' variant='heading4'>{title}</Text>
                  <CheckedIcon />
            </Box>
              ) : (
                <Box flexDirection='row' justifyContent='space-between' mx='m' mt='m'>
    ...
    <Box backgroundColor="pageBackground" flex={1} height={'100%'}>
      ...
      <Box>
        <Box mt="m" justifyContent="center" alignItems="center">
          <Text variant="heading1">Content Tone & Theme</Text>
          ...
          <Box mt='s'>
            <Animated.View
              ...
              <TouchableOpacity
                ...
                <Text color='lightGrey'>Auto (Ai choose the best)</Text>
                {/* <IconArrow style={aboutOrganizerStatus ? styles.arrow : null} width={10} /> */}
              </TouchableOpacity>
              <Box>
                <FlatList
                    data={mydata}
      ...
      justifyContent="center">
        <Button onPress={() => navigation.navigate('ContentGeneration')} labelColor={'white'} mx="m" variant="primary" label="Continue" />
      </Box>
    </Box>
  );
};
